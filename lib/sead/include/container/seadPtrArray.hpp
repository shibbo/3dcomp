...
namespace sead {
    ...
    public:
        ...
        PtrArrayImpl(s32 maxNumPtrs, void* pBuffer) { setBuffer(maxNumPtrs, pBuffer); }
        ...
        inline s32 getNum() const { return mNumPtrs; }

        inline void* getAt(s32 idx) const { return mPtrArray[idx]; }
